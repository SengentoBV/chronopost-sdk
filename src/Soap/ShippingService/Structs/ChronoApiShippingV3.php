...
/**
 * This class stands for shippingV3 Structs
 * Meta information extracted from the WSDL
 * - type: tns:shippingV3
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiShippingV3 extends AbstractStructBase
{
    /**
     * The esdValue
     * Meta information extracted from the WSDL
     ...
     * @uses ChronoApiShippingV3::setEsdValue()
     * @uses ChronoApiShippingV3::setHeaderValue()
     * @uses ChronoApiShippingV3::setShipperValue()
     * @uses ChronoApiShippingV3::setCustomerValue()
     * @uses ChronoApiShippingV3::setRecipientValue()
     * @uses ChronoApiShippingV3::setRefValue()
     * @uses ChronoApiShippingV3::setSkybillValue()
     * @uses ChronoApiShippingV3::setSkybillParamsValue()
     * @uses ChronoApiShippingV3::setPassword()
     * @uses ChronoApiShippingV3::setVersion()
     * @uses ChronoApiShippingV3::setScheduledValue()
     ...
     * Set esdValue value
     * @param \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiEsdValue $esdValue
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiShippingV3
     */
