...
/**
 * This class stands for getReservedSkybillWithType Structs
 * Meta information extracted from the WSDL
 * - type: tns:getReservedSkybillWithType
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiGetReservedSkybillWithType extends AbstractStructBase
{
    /**
     ...
     * @uses ChronoApiGetReservedSkybillWithType::setReservationNumber()
     ...
     * @param string $reservationNumber
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiGetReservedSkybillWithType
     */
