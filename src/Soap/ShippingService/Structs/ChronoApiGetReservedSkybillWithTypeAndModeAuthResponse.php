...
/**
 * This class stands for getReservedSkybillWithTypeAndModeAuthResponse Structs
 * Meta information extracted from the WSDL
 * - type: tns:getReservedSkybillWithTypeAndModeAuthResponse
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiGetReservedSkybillWithTypeAndModeAuthResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
     ...
     * @uses ChronoApiGetReservedSkybillWithTypeAndModeAuthResponse::setReturn()
     ...
     * Set return value
     * @param \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiResultGetReservedSkybillWithTypeValue $return
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiGetReservedSkybillWithTypeAndModeAuthResponse
     */
