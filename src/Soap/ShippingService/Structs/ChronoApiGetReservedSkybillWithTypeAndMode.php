...
/**
 * This class stands for getReservedSkybillWithTypeAndMode Structs
 * Meta information extracted from the WSDL
 * - type: tns:getReservedSkybillWithTypeAndMode
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiGetReservedSkybillWithTypeAndMode extends AbstractStructBase
{
    /**
     ...
     * @uses ChronoApiGetReservedSkybillWithTypeAndMode::setReservationNumber()
     * @uses ChronoApiGetReservedSkybillWithTypeAndMode::setMode()
     ...
     * @param string $reservationNumber
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiGetReservedSkybillWithTypeAndMode
     */
