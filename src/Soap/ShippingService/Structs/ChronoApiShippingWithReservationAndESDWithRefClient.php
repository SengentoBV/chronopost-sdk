...
/**
 * This class stands for shippingWithReservationAndESDWithRefClient Structs
 * Meta information extracted from the WSDL
 * - type: tns:shippingWithReservationAndESDWithRefClient
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiShippingWithReservationAndESDWithRefClient extends AbstractStructBase
{
    /**
     * The esdValue
     * Meta information extracted from the WSDL
     ...
     * @uses ChronoApiShippingWithReservationAndESDWithRefClient::setEsdValue()
     * @uses ChronoApiShippingWithReservationAndESDWithRefClient::setHeaderValue()
     * @uses ChronoApiShippingWithReservationAndESDWithRefClient::setShipperValue()
     * @uses ChronoApiShippingWithReservationAndESDWithRefClient::setCustomerValue()
     * @uses ChronoApiShippingWithReservationAndESDWithRefClient::setRecipientValue()
     * @uses ChronoApiShippingWithReservationAndESDWithRefClient::setRefValue()
     * @uses ChronoApiShippingWithReservationAndESDWithRefClient::setSkybillValue()
     * @uses ChronoApiShippingWithReservationAndESDWithRefClient::setSkybillParamsValue()
     * @uses ChronoApiShippingWithReservationAndESDWithRefClient::setPassword()
     * @uses ChronoApiShippingWithReservationAndESDWithRefClient::setModeRetour()
     * @uses ChronoApiShippingWithReservationAndESDWithRefClient::setVersion()
     * @uses ChronoApiShippingWithReservationAndESDWithRefClient::setScheduledValue()
     ...
     * Set esdValue value
     * @param \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiEsdWithRefClientValue $esdValue
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiShippingWithReservationAndESDWithRefClient
     */
