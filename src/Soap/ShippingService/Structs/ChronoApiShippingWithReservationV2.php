...
/**
 * This class stands for shippingWithReservationV2 Structs
 * Meta information extracted from the WSDL
 * - type: tns:shippingWithReservationV2
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiShippingWithReservationV2 extends AbstractStructBase
{
    /**
     * The esdValue
     * Meta information extracted from the WSDL
     ...
     * @uses ChronoApiShippingWithReservationV2::setEsdValue()
     * @uses ChronoApiShippingWithReservationV2::setHeaderValue()
     * @uses ChronoApiShippingWithReservationV2::setShipperValue()
     * @uses ChronoApiShippingWithReservationV2::setCustomerValue()
     * @uses ChronoApiShippingWithReservationV2::setRecipientValue()
     * @uses ChronoApiShippingWithReservationV2::setRefValue()
     * @uses ChronoApiShippingWithReservationV2::setSkybillValue()
     * @uses ChronoApiShippingWithReservationV2::setSkybillParamsValue()
     * @uses ChronoApiShippingWithReservationV2::setPassword()
     * @uses ChronoApiShippingWithReservationV2::setModeRetour()
     * @uses ChronoApiShippingWithReservationV2::setVersion()
     * @uses ChronoApiShippingWithReservationV2::setScheduledValue()
     ...
     * Set esdValue value
     * @param \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiEsdWithRefClientValue $esdValue
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiShippingWithReservationV2
     */
