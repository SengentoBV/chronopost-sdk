...
/**
 * This class stands for shippingWithReservation Structs
 * Meta information extracted from the WSDL
 * - type: tns:shippingWithReservation
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiShippingWithReservation extends AbstractStructBase
{
    /**
     * The esdValue
     * Meta information extracted from the WSDL
     ...
     * @uses ChronoApiShippingWithReservation::setEsdValue()
     * @uses ChronoApiShippingWithReservation::setHeaderValue()
     * @uses ChronoApiShippingWithReservation::setShipperValue()
     * @uses ChronoApiShippingWithReservation::setCustomerValue()
     * @uses ChronoApiShippingWithReservation::setRecipientValue()
     * @uses ChronoApiShippingWithReservation::setRefValue()
     * @uses ChronoApiShippingWithReservation::setSkybillValue()
     * @uses ChronoApiShippingWithReservation::setSkybillParamsValue()
     * @uses ChronoApiShippingWithReservation::setPassword()
     * @uses ChronoApiShippingWithReservation::setModeRetour()
     ...
     * Set esdValue value
     * @param \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiEsdValue $esdValue
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiShippingWithReservation
     */
