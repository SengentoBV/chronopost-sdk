...
/**
 * This class stands for shippingMultiParcelV4 Structs
 * Meta information extracted from the WSDL
 * - type: tns:shippingMultiParcelV4
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiShippingMultiParcelV4 extends AbstractStructBase
{
    /**
     * The esdValue
     * Meta information extracted from the WSDL
     ...
     * @uses ChronoApiShippingMultiParcelV4::setEsdValue()
     * @uses ChronoApiShippingMultiParcelV4::setHeaderValue()
     * @uses ChronoApiShippingMultiParcelV4::setShipperValue()
     * @uses ChronoApiShippingMultiParcelV4::setCustomerValue()
     * @uses ChronoApiShippingMultiParcelV4::setRecipientValue()
     * @uses ChronoApiShippingMultiParcelV4::setRefValue()
     * @uses ChronoApiShippingMultiParcelV4::setSkybillValue()
     * @uses ChronoApiShippingMultiParcelV4::setSkybillParamsValue()
     * @uses ChronoApiShippingMultiParcelV4::setPassword()
     * @uses ChronoApiShippingMultiParcelV4::setModeRetour()
     * @uses ChronoApiShippingMultiParcelV4::setNumberOfParcel()
     * @uses ChronoApiShippingMultiParcelV4::setVersion()
     * @uses ChronoApiShippingMultiParcelV4::setMultiParcel()
     * @uses ChronoApiShippingMultiParcelV4::setScheduledValue()
     * @uses ChronoApiShippingMultiParcelV4::setRecipientLocalValue()
     * @uses ChronoApiShippingMultiParcelV4::setCustomsValue()
     ...
     * Set esdValue value
     * @param \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiEsdValue3 $esdValue
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiShippingMultiParcelV4
     */
    ...
    public static function validateShipperValueForArrayConstraintsFromSetShipperValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV4ShipperValueItem) {
            ...
            if (!$shippingMultiParcelV4ShipperValueItem instanceof \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiShipperValueV2) {
    ...
    public static function validateRecipientValueForArrayConstraintsFromSetRecipientValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV4RecipientValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV4RecipientValueItem instanceof \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiRecipientValueV2) {
    ...
    public static function validateRefValueForArrayConstraintsFromSetRefValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV4RefValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV4RefValueItem instanceof \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiRefValueV2) {
    ...
    public static function validateSkybillValueForArrayConstraintsFromSetSkybillValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV4SkybillValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV4SkybillValueItem instanceof \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiSkybillWithDimensionsValueV6) {
    ...
    public static function validateScheduledValueForArrayConstraintsFromSetScheduledValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV4ScheduledValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV4ScheduledValueItem instanceof \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiScheduledValue) {
    ...
    public static function validateRecipientLocalValueForArrayConstraintsFromSetRecipientLocalValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV4RecipientLocalValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV4RecipientLocalValueItem instanceof \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiRecipientLocalValueV2) {
    ...
    public static function validateCustomsValueForArrayConstraintsFromSetCustomsValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV4CustomsValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV4CustomsValueItem instanceof \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiCustomsValue) {
