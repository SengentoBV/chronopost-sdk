...
/**
 * This class stands for resultReservationExpeditionValueV2 Structs
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiResultReservationExpeditionValueV2 extends ChronoApiResultReservationExpeditionValue
{
    /**
     * The asCode
     ...
     * @uses ChronoApiResultReservationExpeditionValueV2::setAsCode()
     * @param string $asCode
     */
     ...
     * Set asCode value
     * @param string $asCode
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiResultReservationExpeditionValueV2
     */
