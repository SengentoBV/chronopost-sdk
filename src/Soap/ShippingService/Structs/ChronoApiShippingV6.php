...
/**
 * This class stands for shippingV6 Structs
 * Meta information extracted from the WSDL
 * - type: tns:shippingV6
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiShippingV6 extends AbstractStructBase
{
    /**
     * The esdValue
     * Meta information extracted from the WSDL
     ...
     * @uses ChronoApiShippingV6::setEsdValue()
     * @uses ChronoApiShippingV6::setHeaderValue()
     * @uses ChronoApiShippingV6::setShipperValue()
     * @uses ChronoApiShippingV6::setCustomerValue()
     * @uses ChronoApiShippingV6::setRecipientValue()
     * @uses ChronoApiShippingV6::setRefValue()
     * @uses ChronoApiShippingV6::setSkybillValue()
     * @uses ChronoApiShippingV6::setSkybillParamsValue()
     * @uses ChronoApiShippingV6::setPassword()
     * @uses ChronoApiShippingV6::setVersion()
     * @uses ChronoApiShippingV6::setScheduledValue()
     ...
     * Set esdValue value
     * @param \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiEsdValue3 $esdValue
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiShippingV6
     */
