...
/**
 * This class stands for shippingV5Response Structs
 * Meta information extracted from the WSDL
 * - type: tns:shippingV5Response
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiShippingV5Response extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
     ...
     * @uses ChronoApiShippingV5Response::setReturn()
     ...
     * Set return value
     * @param \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiResultExpeditionValue $return
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiShippingV5Response
     */
