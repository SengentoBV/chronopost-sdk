...
/**
 * This class stands for shippingV4Response Structs
 * Meta information extracted from the WSDL
 * - type: tns:shippingV4Response
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiShippingV4Response extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
     ...
     * @uses ChronoApiShippingV4Response::setReturn()
     ...
     * Set return value
     * @param \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiResultExpeditionValue $return
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiShippingV4Response
     */
