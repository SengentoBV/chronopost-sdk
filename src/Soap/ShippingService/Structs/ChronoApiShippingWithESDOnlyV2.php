...
/**
 * This class stands for shippingWithESDOnlyV2 Structs
 * Meta information extracted from the WSDL
 * - type: tns:shippingWithESDOnlyV2
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiShippingWithESDOnlyV2 extends AbstractStructBase
{
    /**
     * The esdValue
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiEsdWithRefClientValueV2|null
     */
    protected ?\SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiEsdWithRefClientValueV2 $esdValue = null;
    /**
     * The headerValue
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * @uses ChronoApiShippingWithESDOnlyV2::setEsdValue()
     * @uses ChronoApiShippingWithESDOnlyV2::setHeaderValue()
     * @uses ChronoApiShippingWithESDOnlyV2::setShipperValue()
     * @uses ChronoApiShippingWithESDOnlyV2::setCustomerValue()
     * @uses ChronoApiShippingWithESDOnlyV2::setRecipientValue()
     * @uses ChronoApiShippingWithESDOnlyV2::setRefValue()
     * @uses ChronoApiShippingWithESDOnlyV2::setSkybillValue()
     * @uses ChronoApiShippingWithESDOnlyV2::setSkybillParamsValue()
     * @uses ChronoApiShippingWithESDOnlyV2::setPassword()
     * @uses ChronoApiShippingWithESDOnlyV2::setModeRetour()
     * @uses ChronoApiShippingWithESDOnlyV2::setVersion()
     * @param \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiEsdWithRefClientValueV2 $esdValue
    ...
    /**
     * Get esdValue value
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiEsdWithRefClientValueV2|null
     */
    public function getEsdValue(): ?\SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiEsdWithRefClientValueV2
    {
     ...
     * Set esdValue value
     * @param \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiEsdWithRefClientValueV2 $esdValue
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiShippingWithESDOnlyV2
     */
    public function setEsdValue(?\SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiEsdWithRefClientValueV2 $esdValue = null): self
    {
