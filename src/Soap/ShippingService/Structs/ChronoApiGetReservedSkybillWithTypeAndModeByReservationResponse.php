 ...
 * @subpackage Structs
 */
class ChronoApiGetReservedSkybillWithTypeAndModeByReservationResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
     ...
     * @uses ChronoApiGetReservedSkybillWithTypeAndModeByReservationResponse::setReturn()
     ...
     * Set return value
     * @param \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiResultGetReservedSkybillWithTypeValue $return
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiGetReservedSkybillWithTypeAndModeByReservationResponse
     */
