...
/**
 * This class stands for shippingV4 Structs
 * Meta information extracted from the WSDL
 * - type: tns:shippingV4
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiShippingV4 extends AbstractStructBase
{
    /**
     * The esdValue
     * Meta information extracted from the WSDL
     ...
     * @uses ChronoApiShippingV4::setEsdValue()
     * @uses ChronoApiShippingV4::setHeaderValue()
     * @uses ChronoApiShippingV4::setShipperValue()
     * @uses ChronoApiShippingV4::setCustomerValue()
     * @uses ChronoApiShippingV4::setRecipientValue()
     * @uses ChronoApiShippingV4::setRefValue()
     * @uses ChronoApiShippingV4::setSkybillValue()
     * @uses ChronoApiShippingV4::setSkybillParamsValue()
     * @uses ChronoApiShippingV4::setPassword()
     * @uses ChronoApiShippingV4::setVersion()
     * @uses ChronoApiShippingV4::setScheduledValue()
     ...
     * Set esdValue value
     * @param \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiEsdValue $esdValue
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiShippingV4
     */
