...
/**
 * This class stands for shippingResponse Structs
 * Meta information extracted from the WSDL
 * - type: tns:shippingResponse
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiShippingResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
     ...
     * @uses ChronoApiShippingResponse::setReturn()
     ...
     * Set return value
     * @param \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiResultExpeditionValue $return
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiShippingResponse
     */
