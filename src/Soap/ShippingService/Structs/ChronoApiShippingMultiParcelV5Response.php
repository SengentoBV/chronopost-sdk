...
/**
 * This class stands for shippingMultiParcelV5Response Structs
 * Meta information extracted from the WSDL
 * - type: tns:shippingMultiParcelV5Response
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiShippingMultiParcelV5Response extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
     ...
     * @uses ChronoApiShippingMultiParcelV5Response::setReturn()
     ...
     * Set return value
     * @param \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiResultMultiParcelExpeditionValue $return
     * @return \SengentoBV\ChronopostSdk\Soap\ShippingService\Structs\ChronoApiShippingMultiParcelV5Response
     */
