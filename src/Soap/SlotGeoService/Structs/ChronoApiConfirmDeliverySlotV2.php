...
/**
 * This class stands for confirmDeliverySlotV2 Structs
 * Meta information extracted from the WSDL
 * - type: tns:confirmDeliverySlotV2
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiConfirmDeliverySlotV2 extends AbstractStructBase
{
    /**
     * The callerTool
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for confirmDeliverySlotV2
     * @uses ChronoApiConfirmDeliverySlotV2::setCallerTool()
     * @uses ChronoApiConfirmDeliverySlotV2::setProductType()
     * @uses ChronoApiConfirmDeliverySlotV2::setCodeSlot()
     * @uses ChronoApiConfirmDeliverySlotV2::setMeshCode()
     * @uses ChronoApiConfirmDeliverySlotV2::setTransactionID()
     * @uses ChronoApiConfirmDeliverySlotV2::setRank()
     * @uses ChronoApiConfirmDeliverySlotV2::setPosition()
     * @uses ChronoApiConfirmDeliverySlotV2::setDateSelected()
     ...
     * @param string $callerTool
     * @return \SengentoBV\ChronopostSdk\Soap\SlotGeoService\Structs\ChronoApiConfirmDeliverySlotV2
     */
