 ...
 * @subpackage Structs
 */
class ChronoApiRecherchePointRelaisParCoordonneesGeographiquesParService extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiquesParService::setAccountNumber()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiquesParService::setPassword()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiquesParService::setCountryCode()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiquesParService::setCoordGeoLatitude()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiquesParService::setCoordGeoLongitude()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiquesParService::setType()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiquesParService::setProductCode()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiquesParService::setService()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiquesParService::setWeight()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiquesParService::setShippingDate()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiquesParService::setMaxPointChronopost()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiquesParService::setMaxDistanceSearch()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiquesParService::setHolidayTolerant()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiquesParService::setServiceList()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiquesParService::setLanguage()
     ...
     * @param string $accountNumber
     * @return \SengentoBV\ChronopostSdk\Soap\RelayPointService\Structs\ChronoApiRecherchePointRelaisParCoordonneesGeographiquesParService
     */
