...
/**
 * This class stands for recherchePointRelaisParCoordonneesGeographiques Structs
 * Meta information extracted from the WSDL
 * - type: tns:recherchePointRelaisParCoordonneesGeographiques
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiRecherchePointRelaisParCoordonneesGeographiques extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for recherchePointRelaisParCoordonneesGeographiques
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiques::setAccountNumber()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiques::setPassword()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiques::setCoordGeoLatitude()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiques::setCoordGeoLongitude()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiques::setType()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiques::setProductCode()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiques::setService()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiques::setWeight()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiques::setShippingDate()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiques::setMaxPointChronopost()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiques::setMaxDistanceSearch()
     * @uses ChronoApiRecherchePointRelaisParCoordonneesGeographiques::setHolidayTolerant()
     ...
     * @param string $accountNumber
     * @return \SengentoBV\ChronopostSdk\Soap\RelayPointService\Structs\ChronoApiRecherchePointRelaisParCoordonneesGeographiques
     */
