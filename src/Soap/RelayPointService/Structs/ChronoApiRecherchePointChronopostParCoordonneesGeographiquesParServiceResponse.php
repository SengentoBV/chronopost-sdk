 ...
 * recherchePointChronopostParCoordonneesGeographiquesParServiceResponse Structs
 * Meta information extracted from the WSDL
 * - type: tns:recherchePointChronopostParCoordonneesGeographiquesParServiceResponse
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiRecherchePointChronopostParCoordonneesGeographiquesParServiceResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
     ...
     * @uses ChronoApiRecherchePointChronopostParCoordonneesGeographiquesParServiceResponse::setReturn()
     ...
     * Set return value
     * @param \SengentoBV\ChronopostSdk\Soap\RelayPointService\Structs\ChronoApiPointCHRResult $return
     * @return \SengentoBV\ChronopostSdk\Soap\RelayPointService\Structs\ChronoApiRecherchePointChronopostParCoordonneesGeographiquesParServiceResponse
     */
