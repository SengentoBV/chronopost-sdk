...
/**
 * This class stands for recherchePointChronopostInterParServiceAGL Structs
 * Meta information extracted from the WSDL
 * - type: tns:recherchePointChronopostInterParServiceAGL
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiRecherchePointChronopostInterParServiceAGL extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
     ...
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setAccountNumber()
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setPassword()
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setAddress()
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setZipCode()
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setCity()
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setCountryCode()
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setType()
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setProductCode()
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setService()
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setWeight()
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setShippingDate()
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setMaxPointChronopost()
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setMaxDistanceSearch()
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setHolidayTolerant()
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setServiceList()
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setLanguage()
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setVersion()
     * @uses ChronoApiRecherchePointChronopostInterParServiceAGL::setAmaGeoLoc()
     ...
     * @param string $accountNumber
     * @return \SengentoBV\ChronopostSdk\Soap\RelayPointService\Structs\ChronoApiRecherchePointChronopostInterParServiceAGL
     */
