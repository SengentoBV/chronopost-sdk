...
/**
 * This class stands for rechercheBtAvecPFParCodeproduitEtCodepostalEtDate Structs
 * Meta information extracted from the WSDL
 * - type: tns:rechercheBtAvecPFParCodeproduitEtCodepostalEtDate
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiRechercheBtAvecPFParCodeproduitEtCodepostalEtDate extends AbstractStructBase
{
    /**
     * The codeProduit
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for rechercheBtAvecPFParCodeproduitEtCodepostalEtDate
     * @uses ChronoApiRechercheBtAvecPFParCodeproduitEtCodepostalEtDate::setCodeProduit()
     * @uses ChronoApiRechercheBtAvecPFParCodeproduitEtCodepostalEtDate::setCodePostal()
     * @uses ChronoApiRechercheBtAvecPFParCodeproduitEtCodepostalEtDate::setDate()
     ...
     * @param string $codeProduit
     * @return \SengentoBV\ChronopostSdk\Soap\RelayPointService\Structs\ChronoApiRechercheBtAvecPFParCodeproduitEtCodepostalEtDate
     */
