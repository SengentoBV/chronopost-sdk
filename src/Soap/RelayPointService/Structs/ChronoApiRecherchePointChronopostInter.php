...
/**
 * This class stands for recherchePointChronopostInter Structs
 * Meta information extracted from the WSDL
 * - type: tns:recherchePointChronopostInter
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiRecherchePointChronopostInter extends AbstractStructBase
{
    /**
     * The accountNumber
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for recherchePointChronopostInter
     * @uses ChronoApiRecherchePointChronopostInter::setAccountNumber()
     * @uses ChronoApiRecherchePointChronopostInter::setPassword()
     * @uses ChronoApiRecherchePointChronopostInter::setAddress()
     * @uses ChronoApiRecherchePointChronopostInter::setZipCode()
     * @uses ChronoApiRecherchePointChronopostInter::setCity()
     * @uses ChronoApiRecherchePointChronopostInter::setCountryCode()
     * @uses ChronoApiRecherchePointChronopostInter::setType()
     * @uses ChronoApiRecherchePointChronopostInter::setProductCode()
     * @uses ChronoApiRecherchePointChronopostInter::setService()
     * @uses ChronoApiRecherchePointChronopostInter::setWeight()
     * @uses ChronoApiRecherchePointChronopostInter::setShippingDate()
     * @uses ChronoApiRecherchePointChronopostInter::setMaxPointChronopost()
     * @uses ChronoApiRecherchePointChronopostInter::setMaxDistanceSearch()
     * @uses ChronoApiRecherchePointChronopostInter::setHolidayTolerant()
     * @uses ChronoApiRecherchePointChronopostInter::setLanguage()
     * @uses ChronoApiRecherchePointChronopostInter::setVersion()
     ...
     * @param string $accountNumber
     * @return \SengentoBV\ChronopostSdk\Soap\RelayPointService\Structs\ChronoApiRecherchePointChronopostInter
     */
