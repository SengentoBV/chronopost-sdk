...
/**
 * This class stands for getAllChronopostAgencesResponse Structs
 * Meta information extracted from the WSDL
 * - type: tns:getAllChronopostAgencesResponse
 * @package ChronoApi
 * @subpackage Structs
 */
class ChronoApiGetAllChronopostAgencesResponse extends AbstractStructBase
{
    /**
     * The return
     * Meta information extracted from the WSDL
     ...
     * @uses ChronoApiGetAllChronopostAgencesResponse::setReturn()
    ...
    public static function validateReturnForArrayConstraintsFromSetReturn(?array $values = []): string
    {
        ...
        foreach ($values as $getAllChronopostAgencesResponseReturnItem) {
            ...
            if (!$getAllChronopostAgencesResponseReturnItem instanceof \SengentoBV\ChronopostSdk\Soap\RelayPointService\Structs\ChronoApiPointChronopost) {
